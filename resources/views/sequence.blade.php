...
<div class="container-fluid sequence_container">
	...
	<div class="row">		
		<div class="col-md-2 filters">
			...
			{{ Form::open(array('url' => 'sequences', 'role' => 'form', 'method' => 'post', 'class' => 'sequence_search show_reloading_message')) }}
		...
		<div class="col-md-10">
			<div class="reloading_contents">
				...
				@if (! empty($sequence_list))
					<a href="/sequences-download?query_id={{ $query_id }}" class="btn btn-primary pull-right download_sequences">
