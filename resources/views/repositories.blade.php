			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="col-md-5 browse-data">
						<a role="button" class="btn btn-primary"  href="/samples?">
							Browse data →
						</a>
					</div>				
				</div>
	...
	<!-- <div class="col-md-4 repository">
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<h4>United States</h4>
				<img class="logo" src="/images/repositories/ireceptor.png" />
			</div>
			<div class="panel-body">
				<div class="row">
					<div class="col-md-7">
			...
			<div class="panel-footer">
				<ul>
					<li>
						<span class="glyphicon glyphicon-globe" aria-hidden="true"></span> 
						<a class="external" target="_blank" href="https://vdjserver.org/airr/v1/info">https://vdjserver.org/airr/v1/info</a>
					</li>
					<li>
						<span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> 
						<a class="email" href="mailto:vdjserver@utsouthwestern.edu">vdjserver@utsouthwestern.edu</a>
					</li>
					</ul>
			</div>
		</div>
