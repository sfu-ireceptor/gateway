			...
			<tr>
				...
				<td>
					...
					@elseif($d->isDone())
						...
						@if($d->isIncomplete())
							<span class="help help_queue_position text-danger" role="button" data-container="body" data-toggle="popover_form_field" data-placement="right" title="Download is incomplete" data-content="<p>{{ $d->incomplete_info }}</p>" data-trigger="hover" tabindex="0">
