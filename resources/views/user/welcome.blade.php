...
<p>Your account has been successfully created and enabled with
limited access to the iReceptor Gateway as we review and approve your
request for an Academic Subscription.
You will receive an email shortly with your username and password
that will enable you to log in with limited access. Please use the <a href="/user/account">User Account page</a> to change your password.
</p>

<p>
You will receive an email notification when your Academic Subscription
has been approved.
