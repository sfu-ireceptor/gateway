...
return [
    ...
    */
    ...
    'tapis' => [
        ...
        'app_directories' => [
            'stats', 'histogram', 'clone-stats', 'cell-conga-singularity', 'cell-celltypist-singularity', 'immunarch-singularity', 'rearrangement-repcred-singularity', 'rearrangement-cdr3_motif-singularity', 'rearrangement-base-app', 'rearrangement-tcrmatch-singularity',
        ],
        'system_execution' => [
